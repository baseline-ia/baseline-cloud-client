...
- Update: `baseline-cloud update`; use it when the globally installed CLI is stale, then let its post-update setup refresh detected integrations without replacing user files.
